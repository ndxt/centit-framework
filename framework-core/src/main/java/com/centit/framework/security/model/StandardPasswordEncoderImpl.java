...
public class StandardPasswordEncoderImpl implements CentitPasswordEncoder, PasswordEncoder {
    ...
    public String encodePassword(String rawPass, Object salt) {
        return StandardPasswordEncoderImpl.createPassword(rawPass, StringBaseOpt.castObjectToString(salt),strength);
    }
    ...
    public boolean isPasswordValid(String encodedPassword, String rawPass, Object salt) {
        return StringUtils.equals(
                encodedPassword,
                StandardPasswordEncoderImpl.createPassword(rawPass, StringBaseOpt.castObjectToString(salt),strength));
    }
    ...
    public static String createPassword(String password, String salt, int logRounds) {
        CentitCrypt b = new CentitCrypt();
        byte[] pb = b.crypt_raw(password.getBytes(), salt.getBytes(), logRounds );
        return new String(Hex.encodeHex(pb));
    }
*/
